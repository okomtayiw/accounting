...
class ActivityTransactionLedgerPreview : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityTransactionLedgerPreviewBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTransactionLedgerPreviewBinding.inflate(layoutInflater)
        ...
        adapter = TransactionLedgerAdapter()
