...
//        }, viewLifecycleOwner, Lifecycle.State.RESUMED)
        ...
        val (startOfWeekMillis, endOfWeekMillis) = DateUtil.getStartAndEndOfWeek()
        journalViewModel.getJournalsForWeek(startOfWeekMillis, endOfWeekMillis).observe(viewLifecycleOwner) { journalWithDetailsList ->
